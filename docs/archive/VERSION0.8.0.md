# Hermes Optimizer Release 0.8.0 — Archived Queue Snapshot
...
- `.hermes/reports/hermesoptimizer/archive/v0.8.0/atoolix-hermes-v0.8-evaluation-2026-04-18.md` for the external concept audit that seeded this slice
- `.hermes/reports/hermesoptimizer/archive/v0.8.0/v0.8-kickoff-2026-04-18.md` for the concrete kickoff order, file-path suggestions, and verification gates
