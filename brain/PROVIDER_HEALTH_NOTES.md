# Provider health notes — v0.9.4

Live canary lanes for this release use generic `lane_state` metadata:
...
- MiniMax/crof/nacrof are examples of generic lane-state handling. They are not required release candidates unless their canaries are explicitly green and marked `required_release`.
